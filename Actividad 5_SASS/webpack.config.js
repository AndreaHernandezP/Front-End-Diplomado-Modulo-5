...
module.exports = { //JSON de configuración del empaquetamiento
    ...
    module: {
        rules:[
            ...
            {
                test: /\.s[ac]ss$/i,    //Pueden ser archivos sass o scss
                use: ['style-loader', 'css-loader', 'sass-loader'], //Se dejan los loaders de css porque estos archivos generan CSS    //Loader que transformara esa extensión
            },
            {
